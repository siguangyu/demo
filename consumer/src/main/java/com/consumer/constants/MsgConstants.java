...
public class MsgConstants {
    ...
    public static final String MSG_NO_MANAGER_USER = "430002";


    //钉钉错误
    public static final String MSG_DINGDING_EXCEPTION = "500001";
    ...
    public static final String MSG_WORK_ORDER_LOCK = "510004";
    // service end
