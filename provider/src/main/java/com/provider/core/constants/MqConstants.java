package com.provider.core.constants;
...
public class MqConstants {
    ...
    //延时重发
    public static final String DELAYED_LETTER_QUEUE = "EIISYS_SMS_V3:DELAYED_LETTER_QUEUE";

    public static final String DELAYED_LETTER_KEY = "EIISYS_SMS_V3:DELAYED_LETTER_KEY";

    public static final String MQ_SMS_DIRECT_EXCHANGE = "EIISYS_SMS_V3:MQ_SMS_DIRECT_EXCHANGE";

    public static final String MQ_SMS_TRANS_QUEUE = "tran_queue";

    public static final String MQ_SMS_TRANS_KEY = "EIISYS_SMS_V3:MQ_SMS_TRANS_KEY";
